        ...
        <div className="max-w-5xl mx-auto space-y-8">
            ...
            >
                <div className="flex items-center gap-2 mb-2 relative z-10">
                    <Calendar className="w-5 h-5 text-[#D08C60]" />
                    <h1 className="font-serif text-2xl font-bold text-[#FEFAEA]">Client Bookings</h1>
                </div>
            </div>
            <div className="p-12 text-center border border-dashed border-[#D08C60] rounded-lg bg-[#FEFAEA]/50">
                <p className="text-[#7A5A43] font-serif">Bookings list module content.</p>
            </div>
        </div>
    );
}
