...
interface PanchottariDashaProps {
    periods: DashaNode[];
}
...
export default function PanchottariDasha({ periods }: PanchottariDashaProps) {
        ...
        <div className="space-y-6 animate-in fade-in duration-700">
            ...
            <div className="bg-[#3E2A1F]/5 rounded-2xl p-4 border border-[#D08C60]/10 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-sm font-black text-[#3E2A1F] uppercase tracking-wider">Panchottari Dasha</h3>
                        <p className="text-[10px] font-bold text-[#8B5A2B]/60 uppercase">105 Year Cycle • 7 Planet System</p>
                    </div>
                </div>
                ...
                <table className="w-full">
                    ...
                    <tbody className="divide-y divide-[#D08C60]/10 font-medium">
                        {periods.map((mahadasha, mIdx) => {
                            ...
                            const isBalance = (mahadasha.raw as any)?.balance_at_birth === true || (mahadasha.raw as any)?.is_balance === true;
