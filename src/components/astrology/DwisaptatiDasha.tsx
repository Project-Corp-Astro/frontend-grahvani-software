            ...
            {!isApplicable && (
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-amber-700">This Dwisaptati Sama system requires Lagna lord in 7th house for applicability.</p>
                    </div>
                </div>
            )}
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-bold text-[#8B5A2B]/60 uppercase">
                            {availableCycles.length > 1 ? `Cycle ${selectedCycle} of ${availableCycles.length}` : '72 Year Cycle'} • 8 Planet System
                        </p>
                    </div>
                </div>
