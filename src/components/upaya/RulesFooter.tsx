    ...
    return (
        <div className={cn(
            ...
            <div className="flex items-center gap-3 group">
                <div className="w-8 h-8 rounded-full flex items-center justify-center transition-all border" style={{ backgroundColor: 'rgba(255,255,255,0.6)', borderColor: 'var(--border-antique)', color: 'var(--ink)' }}>
                    <Sun className="w-4 h-4 group-hover:text-amber-600 transition-colors" />
                </div>
                <span className="text-[10px] font-black uppercase tracking-tighter transition-colors" style={{ color: 'var(--ink)' }}>
